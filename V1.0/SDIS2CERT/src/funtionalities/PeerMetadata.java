...
public class PeerMetadata implements Runnable{
	...
	public static boolean save(){
		...
		try (
				OutputStream file = new FileOutputStream("new_" + peerInfoDatabaseName);
		...
		try {
			File file = new File("new_" + peerInfoDatabaseName);
			File file2 = new File(peerInfoDatabaseName);
			file2.delete();
			// Rename file
	...
	public static void load() {
		try(
				InputStream file = new FileInputStream(peerInfoDatabaseName);
			...
			HashSet<PeerData> recovered_data = (HashSet<PeerData>) alldata[ind_data];
